...
- [5. ⚙ `visualization_demo.py`로 이해하는 탐색 알고리즘](#sample-code)
  ...
  - [5.2. 환경 정의](#mctx-env)
  - [5.3. 상태 가치의 초기값](#mctx-initial-value)
  - [5.4. 정책 네트워크의 사전 확률](#mctx-prior-logits)
  - [5.5. 루트 노드와 상태 전이 함수 호출 예시](#mctx-root-node-and-recurrent-fn)
  - [5.6. `gumbel_muzero_policy` 호출 예시](#gumbel-muzero-policy)
- [6. 🏁 마치며](#conclusion)
